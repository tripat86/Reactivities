...
export default function LocationInput<T extends FieldValues>(props: Props<T>) {
    ...
    const locationUrl = 'https://api.locationiq.com/v1/autocomplete?key=pk.0c19f0a8f0120fda0c84a8431ed8dc6c&limit=5&dedupe=1&';
    ...
    const handleSelect = (suggestion: LocationIQSuggestion) => {
        ...
        setInputValue(venue);
        field.onChange({ city,venue,latitude,longitude}); //RHF will handle the object
        setSuggestions([]);
        setLoading(false);       
    }
